...
local-standard: generate-secrets
	...
	rm composer-setup.php
	if [ ! -d ./codebase ]; then \
		git clone -b islandora_lite https://github.com/digitalutsc/islandora-sandbox.git codebase; \
	fi
